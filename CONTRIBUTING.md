# Contributing to Agent Harness Game Studios

AHGS is a coordination framework for indie game development using Claude Code.
...
AHGS is the system that helps you build games, not a place to store the games
you build with it. GDDs, ADRs, PRDs, game concepts, level designs, narrative
docs, or any other output generated by AHGS for your own project won't be
...
AHGS is not an autonomous system. Every workflow follows:
...
AHGS must work on Windows (Git Bash), macOS, and Linux. If your hook or
