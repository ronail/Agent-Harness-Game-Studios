...
If OFF TRACK, use `AskUserQuestion`, `request_user_input` or `clarify` before generating the recommendation:
...
If AT RISK, use `AskUserQuestion`, `request_user_input` or `clarify`:
