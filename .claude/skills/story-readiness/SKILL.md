...
user-invocable: true
allowed-tools: Read, Glob, Grep, AskUserQuestion, clarify, Task
model: sonnet
---
...
**Scope:** `$ARGUMENTS[0]` (blank = ask user via AskUserQuestion or clarify)
...
- **GAPS [list]** → surface the specific gaps to the user via `AskUserQuestion` or clarify:
