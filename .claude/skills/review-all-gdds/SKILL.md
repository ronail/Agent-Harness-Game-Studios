...
Use `AskUserQuestion`, `request_user_input` or `clarify` for write permission:
...
After all file writes are complete, use `AskUserQuestion`, `request_user_input` or `clarify` for a closing widget.
