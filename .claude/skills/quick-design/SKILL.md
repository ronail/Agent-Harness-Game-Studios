...
Present the inferred classification using `AskUserQuestion` or `request_user_input` or `clarify`:
...
Present the draft to the user in full. Then use `AskUserQuestion` or `request_user_input` or `clarify`:
