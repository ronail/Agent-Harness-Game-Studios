...
Present the inferred classification using `AskUserQuestion`, `request_user_input` or `clarify`:
...
Present the draft to the user in full. Then use `AskUserQuestion`, `request_user_input` or `clarify`:
