...
Use `AskUserQuestion`, `request_user_input` or `clarify` to batch-verify. Keep to at most 3 calls.
...
- Use `AskUserQuestion`, `request_user_input` or `clarify` for all manual smoke check verification.
