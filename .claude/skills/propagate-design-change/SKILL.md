...
- **CONCERNS** → surface the specific ADRs or recommendations flagged; use `AskUserQuestion` or `request_user_input` or `clarify` with options: `Revise the impact assessment` / `Accept with noted concerns` / `Discuss further`
